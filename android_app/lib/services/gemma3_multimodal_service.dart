...
class Gemma3MultimodalService {
  ...
  Future<String> processMultimodalInput(String textInput, [dynamic imageInput, dynamic audioInput]) async {
    try {
  ...
  Future<String> generateContextualResponse(String context, String query) async {
    try {
