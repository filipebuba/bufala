...
class _EducationScreenEnhancedState extends State<EducationScreenEnhanced>
          ...
          Row(
            ...
            children: [
              ...
              _buildStatItem(
                ...
                value: '${(_completedLessons / _totalLessons * 100).toInt()}%',
  ...
  Widget _buildStatItem({required IconData icon, required String value, required String label}) => Column(
      children: [
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: _useCreole ? 'Buska materia...' : 'Buscar matéria...',
                  ...
                  child: GridView.builder(
                    ...
                    itemCount: subjects
                        .where((subject) => 
                            ...
                            subject['title'].toString().toLowerCase().contains(_searchQuery))
                        .length,
  ...
  Widget _buildContentCard(OfflineLearningContent content, int index) => Container(
  ...
  String _getSubjectTitle() {
    switch (_selectedSubject) {
      case 'literacy': return _useCreole ? 'Alfabetisason' : 'Alfabetização';
      case 'math': return _useCreole ? 'Matematika' : 'Matemática';
      case 'health': return _useCreole ? 'Saúdi' : 'Saúde';
      case 'agriculture': return _useCreole ? 'Agrikultura' : 'Agricultura';
      case 'science': return _useCreole ? 'Siensia' : 'Ciências';
      case 'environment': return _useCreole ? 'Ambiente' : 'Meio Ambiente';
      default: return '';
    }
  }
  ...
  String _getSubjectSubtitle() {
    switch (_selectedSubject) {
      case 'literacy': return _useCreole ? 'Lê i skrebê' : 'Ler e escrever';
      case 'math': return _useCreole ? 'Numeru i kontu' : 'Números e cálculos';
      case 'health': return _useCreole ? 'Kuidadu ku korpu' : 'Cuidados com o corpo';
      case 'agriculture': return _useCreole ? 'Plantason i animais' : 'Plantação e animais';
      case 'science': return _useCreole ? 'Natura i mundu' : 'Natureza e mundo';
      case 'environment': return _useCreole ? 'Proteje natura' : 'Proteger a natureza';
      default: return '';
    }
  }
  ...
  Color _getSubjectColor() {
    switch (_selectedSubject) {
      case 'literacy': return Colors.blue;
      case 'math': return Colors.green;
      case 'health': return Colors.red;
      case 'agriculture': return Colors.brown;
      case 'science': return Colors.purple;
      case 'environment': return Colors.teal;
  ...
  IconData _getSubjectIcon() {
    switch (_selectedSubject) {
      case 'literacy': return Icons.book;
  ...
  IconData _getContentIcon(String type) {
    switch (type) {
      ...
      case 'audio': return Icons.volume_up;
      case 'text': return Icons.article;
      case 'quiz': return Icons.quiz;
      case 'exercise': return Icons.assignment;
      default: return Icons.school;
    }
  }
  ...
  IconData _getDifficultyIcon(String difficulty) {
    switch (difficulty) {
      case 'easy': return Icons.sentiment_very_satisfied;
  ...
  Future<void> _createNewLessonWithAI() async {
    ...
    try {
      final response = await _smartApiService.askEducationQuestion(
        question: 'Criar nova lição sobre: $lessonTopic para ${_getSubjectTitle()}',
        language: _useCreole ? 'crioulo-gb' : 'pt-BR',
  ...
  void _updateProgress(OfflineLearningContent content) {
    setState(() {
      ...
      _subjectProgress[_selectedSubject] = (currentProgress + 0.1).clamp(0.0, 1.0);
