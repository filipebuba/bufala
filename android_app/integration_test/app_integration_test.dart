...
void main() {
  ...
  group('Morana App Integration Tests', () {
    ...
    testWidgets('Home screen should display main features',
    ...
    testWidgets('Connection status should be displayed',
        (WidgetTester tester) async {
      // Arrange
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
    ...
    testWidgets('App should handle multiple navigation actions',
        (WidgetTester tester) async {
      // Arrange
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
    ...
    testWidgets('App should display language information',
        (WidgetTester tester) async {
      // Arrange
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
    ...
    testWidgets('App should handle screen rotations',
        (WidgetTester tester) async {
      // Arrange
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
    ...
    testWidgets('App should maintain state during navigation',
      ...
      final initialWidgetCount =
          find.byType(QuickActionButton).evaluate().length;
    ...
    testWidgets('App should display proper UI elements',
        (WidgetTester tester) async {
      // Arrange
      app.main();
      await tester.pumpAndSettle(const Duration(seconds: 3));
      ...
      expect(find.byType(AppBar),
          findsAtLeastNWidgets(0)); // May or may not have AppBar
      expect(find.byType(Column), findsAtLeastNWidgets(1));
      expect(find.byType(Container), findsAtLeastNWidgets(1));
    });

    testWidgets('Performance test - app should load within reasonable time',
        (WidgetTester tester) async {
      // Arrange
